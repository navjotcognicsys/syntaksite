                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-7">
                            <div class="banner-img">
                                <img src="{{asset('assets/images/home-three/home-three-img.png')}}" alt="Images">
                                <div class="banner-img-shape">
                                    <img src="{{asset('assets/images/home-three/home-three-shape.png')}}" alt="Images">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="banner-sub-slider owl-carousel owl-theme">
                    <div class="banner-sub-item">
                        <img src="{{asset('assets/images/home-three/home-three-sub1.jpg')}}" alt="Images">
                        <div class="content">
                            <h3>200+</h3>
                    ...
                    <div class="banner-sub-item">
                        <img src="{{asset('assets/images/home-three/home-three-sub2.jpg')}}" alt="Images">
                        <div class="content">
                            <h3>10+</h3>
                    ...
                    <div class="banner-sub-item">
                        <img src="{{asset('assets/images/home-three/home-three-sub3.jpg')}}" alt="Images">
                        <div class="content">
                            <h3>500+</h3>
            ...
            <div class="row pt-45">
                <div class="col-lg-12 col-sm-6">
                    <div class="services-card services-style-bg">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{asset('assets/images/services/webdev.png')}}" height="90px" width="auto">
                            </div>
                        </div>
                ...
                <div class="col-lg-12 col-sm-6">
                    <div class="services-card services-style-bg">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <h3><a href="{{route('mobiledevelopment')}}">Mobile Development </a> </h3>
                            </div>
                            <div class="col-md-5">
                                <img src="{{asset('assets/images/services/iconss.png')}}" height="90px" width="auto">
                            </div>
                        </div>
                ...
                <div class="col-lg-12 col-sm-6">
                    <div class="services-card services-style-bg">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <h3><a href="{{route('UIUXproto')}}">UI/UX Prototyping </a> </h3>
                            </div>
                            <div class="col-md-5">
                                <img src="{{asset('assets/images/services/webdev.png')}}" height="90px" width="auto">
                            </div>
                ...
                <div class="col-lg-12 col-sm-6">
                    <div class="services-card services-style-bg">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <h3><a href="{{route('graphicdesignproto')}}">Graphic Designing Prototyping </a> </h3>
                            </div>
                            <div class="col-md-5">
                                <img src="{{asset('assets/images/services/webdev.png')}}" height="90px" width="auto">
                            </div>
                ...
                <div class="col-lg-12 col-sm-6">
                    <div class="services-card services-style-bg">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <h3><a href="{{route('digitalmarketing')}}">Digital Marketing </a> </h3>
                            </div>
                            <div class="col-md-5">
                                <img src="{{asset('assets/images/services/webdev.png')}}" height="90px" width="auto">
                            </div>
                ...
                <div class="col-lg-12 col-sm-6">
                    <div class="services-card services-style-bg">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <h3><a href="{{route('retailbranding')}}">Retail Branding </a> </h3>
                            </div>
                            <div class="col-md-5">
                                <img src="{{asset('assets/images/services/webdev.png')}}" height="90px" width="auto">
                            </div>
