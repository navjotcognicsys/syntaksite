		...
		<div class="container">
			<div class="inner-title text-center">
				...
				<ul>
					...
					<li><a href="{{route('careers_page')}}" class="nav-link ">Careers</a></li>
					<li>
						<i class='bx bx-chevrons-right'></i>
					</li>
				...
				<div class="row">
						...
						<div class="job-single-sec">
							<div class="job-single-head2">
								<div class="job-title2">
									<h3>Business Development Executive</h3><span class="job-is ft">Full time</span>
								</div>
								<ul class="tags-jobs">
							...
							<div class="job-overview">
								...
								<ul>
									<li><i class="la la-money"></i>
										<h3>Offerd Salary</h3><span> Best In the Industry</span>
									</li>
									...
									<li><i class="la la-shield"></i>
										<h3>Experience</h3><span>1 to 2 Years</span>
									</li>
					...
					<div class="col-lg-4 column">
						<div class="job-single-head style2">
							<div class="job-thumb"> <img src="{{asset('assets/images/logos/logo-01.png')}}" alt="" height="118px" /> </div>
							...
							<a href="{{route('careers_page')}}" title="" class="viewall-jobs">View all Jobs</a>
						</div><!-- Job Head -->
					</div>
				</div>
			</div>
