            ...
            <div class="row pt-45">
                <div class="col-lg-12 col-sm-6">
                    <div class="services-card services-style-bg">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <h3><a href="{{url("webdevelopment")}}">Web Development</a> </h3>
                            </div>
                            <div class="col-md-5">
                ...
                <div class="col-lg-12 col-sm-6">
                    <div class="services-card services-style-bg">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <h3><a href="{{url("mobiledevelopment")}}">Mobile Development </a> </h3>
                            </div>
                            <div class="col-md-5">
                ...
                <div class="col-lg-12 col-sm-6">
                    <div class="services-card services-style-bg">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <h3><a href="{{url("UIUXproto")}}">UI/UX Prototyping </a> </h3>
                            </div>
                            <div class="col-md-5">
                                <img src="assets/images/services/webdev.png" height="90px" width="auto">
                            </div>
                ...
                <div class="col-lg-12 col-sm-6">
                    <div class="services-card services-style-bg">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <h3><a href="{{url("graphicdesignproto")}}">Graphic Designing Prototyping </a> </h3>
                            </div>
                            <div class="col-md-5">
                                <img src="assets/images/services/webdev.png" height="90px" width="auto">
                            </div>
                ...
                <div class="col-lg-12 col-sm-6">
                    <div class="services-card services-style-bg">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <h3><a href="{{url("digitalmarketing")}}">Digital Marketing </a> </h3>
                            </div>
                            <div class="col-md-5">
                                <img src="assets/images/services/webdev.png" height="90px" width="auto">
                            </div>
                ...
                <div class="col-lg-12 col-sm-6">
                    <div class="services-card services-style-bg">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <h3><a href="{{url("retailbranding")}}">Retail Branding </a> </h3>
                            </div>
                            <div class="col-md-5">
                                <img src="assets/images/services/webdev.png" height="90px" width="auto">
                            </div>
    ...
    <section>
        ...
        <div class="container">
            <div class="talk-content text-center">
                ...
                <a href="{{url('/contact')}}" class="default-btn btn-bg-one border-radius-5">Contact Us</a>
            </div>
        </div>
    </div
