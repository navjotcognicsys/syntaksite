...
<html lang="zxx">
   ...
   <body>
               ...
               <div class="row pt-45">
                  ...
                  <div class="col-lg-6">
                     <div class="contact-form">
                        <form  id="contactFor" action="<?php echo e(url('/email')); ?>" method="post">
                           <?php echo csrf_field(); ?>
                     ...
                     <div class="blog-sec">
                        <div class="row">
                           ...
                           <div class="col-lg-4">
                              <div class="my-blog">
                                 <div class="blog-thumb">
                                    <a href="#" title=""><img src="careers/images/resource/b3.jpg" alt="sdf" /></a>
                                    <div class="blog-metas">
                                       <a href="#" title="">March 29, 2017</a>
                                       <a href="#" title="">0 Comments</a>
                                    </div>
      ...
      <?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/hypedigi/syntaxmantra/resources/views/careers.blade.php ENDPATH**/ ?>