                        ...
                        <div class="row">
                            <div class="col-lg-6 col-6">
                                <div class="choose-content-card">
                                    ...
                                    <p>Our true intention is to grow with you. We shake hands with every possible industry and drive the process with smart efforts in order to make any project worthy. Our hassle-free process just goes with the flow of: Brief | Action | Desired Results</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-6">
                                <div class="choose-content-card">
            ...
            <div class="row pt-45">
                <div class="col-lg-4 col-sm-6">
                    <div class="security-card">
                        ...
                        <h3><a  href="<?php echo e(url('/bussiness-security')); ?>" class="nav-link">Business Security</a></h3>
                        <p>Text Needed</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="security-card">
                        ...
                        <h3><a href="<?php echo e(url('/finest-quality')); ?>" class="nav-link">Finest Quality</a></h3>
                        <p>Text Needed</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
...
</html><?php /**PATH C:\xampp\xamppp\htdocs\syntaxmantra\resources\views/about.blade.php ENDPATH**/ ?>