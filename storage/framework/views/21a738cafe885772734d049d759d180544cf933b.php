...
<!-- Button trigger modal -->
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6">
                    <div class="about-play">
                        <img src="<?php echo e(asset('assets/images/about/it-solutions.png')); ?>" alt="About Images">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="choose-img">
                        <img src="<?php echo e(asset('assets/images/about/aboutsolution.png')); ?>" alt="Images">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="brand-slider owl-carousel owl-theme">
                <div class="brand-item">
                    <img src="<?php echo e(asset('assets/images/brand-logo/logo.png')); ?>" alt="Images">
                </div>
                <div class="brand-item">
                    <img src="<?php echo e(asset('assets/images/brand-logo/cryptonet-logo.png')); ?>" alt="Images" height="85px">
                </div>
                <div class="brand-item">
                    <img src="<?php echo e(asset('assets/images/brand-logo/Nandanvan-New-1.png')); ?>" alt="Images" height="85px">
                </div>
                <div class="brand-item">
                    <img src="<?php echo e(asset('assets/images/brand-logo/painfx.png')); ?>" alt="Images" height="85px">
                </div>
                <div class="brand-item">
                    <img src="<?php echo e(asset('assets/images/brand-logo/rising.png')); ?>" alt="Images" height="85px">
                </div>
                <div class="brand-item">
                    <img src="<?php echo e(asset('assets/images/brand-logo/4pz logo.png')); ?>" alt="Images" height="85px">
                </div>
                 <div class="brand-item">
                    <img src="<?php echo e(asset('assets/images/brand-logo/kids.png')); ?>" alt="Images" height="85px">
                </div>
                 <div class="brand-item">
                    <img src="<?php echo e(asset('assets/images/brand-logo/3dmini.png')); ?>" alt="Images" height="85px">
                </div>
                 <div class="brand-item">
                    <img src="<?php echo e(asset('assets/images/brand-logo/morden.png')); ?>" alt="Images" height="85px">
                </div>
                <!-- <div class="brand-item">-->
    ...
    <div class="counter-area pt-100 pb-70">
        ...
        <div class="counter-shape">
            <div class="shape1">
                <img src="<?php echo e(asset('assets/images/shape/shape1.png')); ?>" alt="Images">
            </div>
            <div class="shape2">
                <img src="<?php echo e(asset('assets/images/shape/shape2.png')); ?>" alt="Images">
            </div>
        </div>
    </div>
    <?php $__env->stopSection(); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Syntax_site\resources\views/pages/about.blade.php ENDPATH**/ ?>