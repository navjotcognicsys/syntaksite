				 	...
				 	<div class="col-lg-8 column">
				 		<div class="job-single-sec">
				 			<div class="job-single-head2">
				 				<div class="job-title2"><h3>UI/UX Designer</h3><span class="job-is ft">Full time</span></div>
				 				<ul class="tags-jobs">
				 			...
				 			<div class="job-details">
				 				<h3>Main Responsibilities of a UI/UX Designer</h3>
				 				<ul>
                                     <li>    Creating user-centered designs by understanding business requirements, and user feedback</li>
                                    <li>     Creating user flows, wireframes, prototypes and mockups
</li>
                                    <li>   Translating requirements into style guides, design systems, design patterns and attractive user interfaces</li>
                                    <li>        Designing UI elements such as input controls, navigational components and informational components

</li>
                                    <li>   Creating original graphic designs (e.g. images, sketches and tables)</li>
									<li>    Identifying and troubleshooting UX problems (e.g. responsiveness)
</li>
<li>    Collaborating effectively with product, engineering, and management teams
</li>
<li>
    Incorporating customer feedback, usage metrics, and usability findings into design in order to enhance user experience                                                                       
				 				...
				 				<ul>
				 					<li>You have a degree/diploma in Design, Fine Arts, Engineering or related field</li>
                                   <li>  You have prior experience as a UI/UX Designer as well as a strong portfolio of related projects</li>
								   <li>    You are proficient in Adobe Creative Suite (specifically Illustrator, InDesign and Photoshop)
</li>
<li>    You are proficient in prototyping tools such as Sketch, InVision, etc.
</li>
<li>    Basic HTML5, CSS3, and JavaScript skills are a plus
</li>
<li>    You pay strong attention to detail and have a keen eye for aesthetics
</li>
<li>    You have excellent communication skills and can clearly articulate your ideas, designs, and suggestions
</li>
				 				</ul>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Apply For UI\UX</h5>
...
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hypedigi/syntaxmantra/resources/views/uiuxcareer.blade.php ENDPATH**/ ?>