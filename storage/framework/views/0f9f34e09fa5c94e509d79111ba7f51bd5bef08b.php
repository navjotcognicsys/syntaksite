				 	...
				 	<div class="col-lg-8 column">
				 		<div class="job-single-sec">
				 			<div class="job-single-head2">
				 				<div class="job-title2"><h3>Full Stack Developer</h3><span class="job-is ft">Full time</span></div>
				 				<ul class="tags-jobs">
				 				...
				 				<span><strong>Roles</strong> :  Full Stack Developer</span>
				 			</div><!-- Job Head -->
				 			<div class="job-details">
				 				<h3>Full Stack Developer Responsibilities:</h3>
				 				<ul>
                                   <li>    Developing front end website architecture.
</li>
<li>    Designing user interactions on web pages.
</li>
<li>    Developing back-end website applications.
	</li>
	<li>    Creating servers and databases for functionality.
</li>
<li>    Ensuring cross-platform optimization for mobile phones.
</li>
...
<li>    Staying abreast of developments in web applications and programming languages.
				 				...
				 				<h3>Full Stack Developer Requirements:
</h3>
				 				<ul>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Apply For fullstack</h5>
...
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/hypedigi/syntaxmantra/resources/views/fullstackdev.blade.php ENDPATH**/ ?>