                    ...
                    <nav class="navbar navbar-expand-md navbar-light ">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav m-auto">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo e(url('/about')); ?>" class="nav-link active">
                                        About
                                    </a>
                                </li>
                                <li class="nav-item">
            ...
            <div class="row pt-45">
                <div class="col-lg-4 col-sm-6">
                    <div class="security-card">
                        ...
                        <h3><a  href="<?php echo e(url('/bussiness-security')); ?>" class="nav-link">Business Solution</a></h3>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="security-card">
                        ...
                        <h3><a href="<?php echo e(url('/manage-it-service')); ?>" class="nav-link">Manage IT Service</a></h3>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="security-card">
                        ...
                        <h3><a href="<?php echo e(url('/product-analysis')); ?>" class="nav-link">Product Analysis</a></h3>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="security-card">
                        ...
                        <h3><a href="<?php echo e(url('/analytic-solution')); ?>" class="nav-link">Analytic Solution</a></h3>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="security-card">
                        ...
                        <h3><a href="<?php echo e(url('/finest-quality')); ?>" class="nav-link">Finest <br>Quality</a></h3>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="security-card">
                        ...
                        <h3><a href="<?php echo e(url('/risk-management')); ?>" class="nav-link">Risk Management</a></h3>
        ...
        <div class="container">
            <div class="brand-slider owl-carousel owl-theme">
                <div class="brand-item">
                    <img src="assets/images/brand-logo/logo.png" alt="Images">
                </div>
                <div class="brand-item">
                    <img src="assets/images/brand-logo/cryptonet-logo.png" alt="Images" height="85px">
                </div>
                <div class="brand-item">
                    <img src="assets/images/brand-logo/Nandanvan-New-1.png" alt="Images" height="85px">
                </div>
                <div class="brand-item">
                    <img src="assets/images/brand-logo/painfx.png" alt="Images" height="85px">
                </div>
                <div class="brand-item">
                    <img src="assets/images/brand-logo/rising.png" alt="Images" height="85px">
                </div>
                <div class="brand-item">
                    <img src="assets/images/brand-logo/4pz logo.png" alt="Images" height="85px">
                </div>
                 <div class="brand-item">
                    <img src="assets/images/brand-logo/kids.png" alt="Images" height="85px">
                </div>
                 <div class="brand-item">
                    <img src="assets/images/brand-logo/3dmini.png" alt="Images" height="85px">
                </div>
                 <div class="brand-item">
                    <img src="assets/images/brand-logo/morden.png" alt="Images" height="85px">
                </div>
                <!-- <div class="brand-item">-->
...
<!-- Mirrored from templates.hibootstrap.com/techex/default/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Dec 2021 07:55:50 GMT -->

</html><?php /**PATH C:\xampp\htdocs\laravel\syntaxmantra\resources\views/about.blade.php ENDPATH**/ ?>