            ...
            <div class="row pt-45">
                <div class="col-lg-12 col-sm-6">
                    <div class="services-card services-style-bg">
                        ...
                        <p>Build responsive web apps with high performance and scalability by leveraging the proven and successful methods of syntax mantra</p>
                ...
                <div class="col-lg-12 col-sm-6">
                    <div class="services-card services-style-bg">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <h3><a href="#">UI/UX Prototyping </a> </h3>
                            </div>
                            <div class="col-md-5">
                                <img src="assets/images/services/webdev.png" height="90px" width="auto">
                            </div>
                        ...
                        <p>Syntax Mantra has been able to boast excellent prototypes with beautiful design thanks to a research-backed UX strategy and engaging user interfaces.</p>
                    </div>
                </div>
                <div class="col-lg-12 col-sm-6">
                    <div class="services-card services-style-bg">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <h3><a href="#">Graphic Designing Prototyping </a> </h3>
                            </div>
                            <div class="col-md-5">
                                <img src="assets/images/services/webdev.png" height="90px" width="auto">
                            </div>
                ...
                <div class="col-lg-12 col-sm-6">
                    <div class="services-card services-style-bg">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <h3><a href="#">Retail Branding </a> </h3>
                            </div>
                            <div class="col-md-5">
                                <img src="assets/images/services/webdev.png" height="90px" width="auto">
                            </div>
...
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\syntaxmantra\resources\views/services-2.blade.php ENDPATH**/ ?>